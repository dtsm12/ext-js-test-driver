StartTest(function(t) {
    ...
    for (j = 1; j <= 5; j++) {
        items.push({
            ...
            src: '020-sencha_touch_2.x/photos/' + j + '.jpg'
        });
    }
    ...
    var leftSwipe   = { action : 'drag', source : start, to : end };
    var rightSwipe  = { action : 'drag', source : end, to : start };
    ...
    t.chain(
        ...
        function(next) { t.is(carousel.getActiveIndex(), 2, 'Index increased to 2'); next(); },
