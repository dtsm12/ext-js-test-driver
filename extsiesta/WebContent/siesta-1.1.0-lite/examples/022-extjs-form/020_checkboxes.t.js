StartTest(function (t) {
    ...
    t.click(fp.down('[id="cb-chrome"]'), function() {
        t.click(fp.down('[name="ie6-not-awesome"]'), function() {
            t.click(fp.down('[boxLabel="Fast"]'), function() {
                t.click(fp.down('[boxLabel="Ext JS"]'), function() {
